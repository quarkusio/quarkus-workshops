...
The GitHub actions take care of publishing a site with the workshop instructions, and also generating source zips.
It's also possible to do these steps locally.
...
You can then open the `docs/target/roq/spine/index.html` page and read the entire documentation of the workshop.
