...
We recommend installing Java using https://sdkman.io/[SDKMAN!]. It provides a convenient Command Line Interface (CLI) and API for installing, switching, removing and listing JDKs. It also avoids the hassle of manually setting the `PATH` variable.
