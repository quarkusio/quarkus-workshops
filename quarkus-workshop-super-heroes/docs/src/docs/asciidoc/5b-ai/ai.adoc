...
----
client.openai.key=
client.openai.endpoint=
client.openai.deploymentname=
----

We also set the port of the Narration microservice to be 8086 by adding the following configuration to the Quarkus `application.properties` file:
