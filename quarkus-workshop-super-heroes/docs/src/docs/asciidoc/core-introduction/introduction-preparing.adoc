...
ifdef::use-gradle[]
Most of these subdirectories are build projects and follow the standard Java directory structure:
endif::use-gradle[]
endif::use-maven[]
ifndef::use-maven[]
ifdef::use-gradle[]
Most of these subdirectories are Gradle projects and follow the standard Java directory structure:
endif::use-gradle[]
endif::use-maven[]
