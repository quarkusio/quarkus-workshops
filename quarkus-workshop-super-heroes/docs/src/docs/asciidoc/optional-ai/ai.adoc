...
plantuml::plantuml/5b-ai-narration-microservice.puml[align=center,width=300,theme="handwritten from {plantuml-theme-dir}"]
...
plantuml::plantuml/5-rest-client-physical-architecture.puml[align=center,width=300,theme="handwritten from {plantuml-theme-dir}"]
