...
Antonio Goncalves; Clement Escoffier; Holly Cummins; Georgios Andrianakis; Emmanuel Bernard; George Gastaldi; Martin Stefanko; Eric Deandrea; Aurea Munoz Hernandez
:doctype: book
...
// Set Kafka keyword for meta tags if messaging is enabled
ifdef::use-messaging[]
:kafka-keyword: , Kafka
endif::use-messaging[]
