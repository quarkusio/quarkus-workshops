...
This workshop needs internet access Azure of course, but also to download all sorts of Maven artifacts, Docker images, and even pictures.
...
https://github.com/quarkusio/quarkus-workshops.git

{github-raw}/dist/quarkus-super-heroes-workshop.zip, and unzip it wherever you want.
