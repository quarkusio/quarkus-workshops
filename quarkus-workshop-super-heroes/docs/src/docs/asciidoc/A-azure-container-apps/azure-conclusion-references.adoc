...
* https://azure.microsoft.com/en-us/services/container-apps[Azure Container Apps Overview]
* https://docs.microsoft.com/en-us/azure/container-apps[Azure Container Apps Documentation]
