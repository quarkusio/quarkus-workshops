...
[source,shell]
----
docker tag ORG/ui-super-heroes:1.0.0-SNAPSHOT  $REGISTRY/ui-super-heroes:1.0.0-SNAPSHOT
docker tag ORG/event-statistics:1.0.0-SNAPSHOT  $REGISTRY/event-statistics:1.0.0-SNAPSHOT
docker tag ORG/rest-fights:1.0.0-SNAPSHOT  $REGISTRY/rest-fights:1.0.0-SNAPSHOT
docker tag ORG/rest-villains:1.0.0-SNAPSHOT  $REGISTRY/rest-villains:1.0.0-SNAPSHOT
docker tag ORG/rest-heroes:1.0.0-SNAPSHOT  $REGISTRY/rest-heroes:1.0.0-SNAPSHOT
----
