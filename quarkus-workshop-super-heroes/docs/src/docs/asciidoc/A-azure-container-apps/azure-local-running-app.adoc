...
----
include::{github-raw}/super-heroes/infrastructure/azure-build-push-registry[tags=adocCompiling]
----
[source,shell,indent=0]
----
include::{github-raw}/super-heroes/infrastructure/azure-build-push-registry[tags=adocBuilding]
----
...
[source,shell,indent=0]
----
include::{github-raw}/super-heroes/infrastructure/azure-build-push-registry[tags=adocTagging]
----
...
[source,shell,indent=0]
----
include::{github-raw}/super-heroes/infrastructure/azure-build-push-registry[tags=adocLogging]
----
...
[source,shell,indent=0]
----
include::{github-raw}/super-heroes/infrastructure/azure-build-push-registry[tags=adocPushing]
----
...
[source,shell,indent=0]
----
include::{github-raw}/super-heroes/infrastructure/azure-build-push-registry[tags=adocListing]
----
...
[source,shell,indent=0]
----
include::{github-raw}/super-heroes/infrastructure/azure-build-push-registry[tags=adocShowing]
----
