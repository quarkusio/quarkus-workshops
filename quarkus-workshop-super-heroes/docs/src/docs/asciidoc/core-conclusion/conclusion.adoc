...
ifndef::use-native[]
If you find it was too short and need more details on Quarkus, Microservices, MicroProfile, or Cloud Native, check the Quarkus website for more references.footnote:[Quarkus https://quarkus.io]
endif::use-native[]
ifdef::use-native[]
...
So with a simple build command you can turn your microservice into a container.
endif::use-container[]
