...
ifdef::use-gradle[]
To check that the `smallrye-health` extension is working as expected, make sure the Hero service is up and running (`./gradlew quarkusDev`) and access using your browser or cURL the following URLs:
endif::use-gradle[]
