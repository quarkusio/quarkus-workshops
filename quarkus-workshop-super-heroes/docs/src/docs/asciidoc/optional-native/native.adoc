...
[.tab-gradle]
--
With Gradle, building a native executable is done by passing `-Dquarkus.native.enabled=true` to the build command, e.g. `./gradlew build -Dquarkus.native.enabled=true -Dquarkus.package.jar.enabled=false`.
--
endif::use-gradle[]
