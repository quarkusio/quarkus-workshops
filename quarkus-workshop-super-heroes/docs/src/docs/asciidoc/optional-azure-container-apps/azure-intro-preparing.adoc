...
include::../core-introduction/introduction-preparing-checking-ports.adoc[leveloffset=+1]

include::../core-introduction/introduction-preparing-warming-docker.adoc[leveloffset=+1]
