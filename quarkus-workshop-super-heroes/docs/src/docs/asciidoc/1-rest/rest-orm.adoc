...
Then, open your browser to http://localhost:8084/api/villains.
...
Open your browser to http://localhost:8084/api/villains, and verify it displays the expected content.
