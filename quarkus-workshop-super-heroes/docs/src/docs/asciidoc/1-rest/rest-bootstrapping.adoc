...
[INFO] Invoking resources:3.3.2:resources (default-resources) @ rest-villains
...
[INFO] Invoking resources:3.3.2:testResources (default-testResources) @ rest-villains
