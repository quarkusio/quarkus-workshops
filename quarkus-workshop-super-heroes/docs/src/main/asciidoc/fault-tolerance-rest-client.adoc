...
[source,xml,indent=0]
----
include::{github-raw}/super-heroes/rest-fight/pom.xml[tags=restClientDependency]
----
...
[source]
----
include::{github-raw}/super-heroes/rest-fight/src/main/java/io/quarkus/workshop/superheroes/fight/FightService.java[tag=adocRestClient]
----
