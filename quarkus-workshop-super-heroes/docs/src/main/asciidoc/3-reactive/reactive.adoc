...
----
include::{plantDir}/hero-physical-architecture.puml[]
----
...
It does not use a transactional service, but use Panache method directly.
...
// TODO LINK
Create the `src/main/resources/import.sql` and copy the content from TODO.
