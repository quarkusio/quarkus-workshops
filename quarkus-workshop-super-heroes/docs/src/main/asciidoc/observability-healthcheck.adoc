...
[source,xml,indent=0]
----
include::{github-raw}/api-hero/pom.xml[tags=adocDependencyHealth]
----
...
[source]
----
include::{github-raw}/api-hero/src/main/java/io/quarkus/workshop/superheroes/hero/health/PingHeroResourceHealthCheck.java[tags=adocPingHero]
----
...
[source]
----
include::{github-raw}/api-hero/src/main/java/io/quarkus/workshop/superheroes/hero/health/DatabaseConnectionHealthCheck.java[tags=adocDatabaseConnection]
----
