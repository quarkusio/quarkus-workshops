...
The purpose of this workshop is to add some load to our application and mesure it with Prometheus.
First, you will download the load application, install it, run it and check some metrics on Prometheus.
