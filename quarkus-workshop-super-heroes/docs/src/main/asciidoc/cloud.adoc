...
* Define this env variable to make easier the config of the microservices urls for
...
The `` property make the UI able to contact the fight microservice. As it is dependending on a env var, consider to define it using the following command:
