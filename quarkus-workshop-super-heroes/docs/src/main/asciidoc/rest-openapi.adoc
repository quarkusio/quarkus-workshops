...
[source,xml,indent=0]
----
include::{github-raw}/api-hero/pom.xml[tags=adocDependencyOpenAPI]
----
...
[source,yaml]
----
include::{github-raw}/api-hero/openapi-origin.yaml[]
----
...
[source]
----
include::{github-raw}/api-hero/src/main/java/io/quarkus/workshop/superheroes/hero/HeroResource.java[tags=adocResource;!adocMetrics]
----
...
[source]
----
include::{github-raw}/api-hero/src/main/java/io/quarkus/workshop/superheroes/hero/HeroApplication.java[tags=adocApplication]
----
...
[source,yaml]
----
include::{github-raw}/api-hero/openapi.yaml[]
----
...
[source,indent=0]
----
include::{github-raw}/api-hero/src/test/java/io/quarkus/workshop/superheroes/hero/HeroResourceTest.java[tags=adocOpenAPI]
----
