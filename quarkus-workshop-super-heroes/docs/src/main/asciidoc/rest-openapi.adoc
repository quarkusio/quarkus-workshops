...
Now, you _curl_ `http://localhost:8083/q/openapi` endpoint:
...
If you go back to the `http://localhost:8083/q/openapi` endpoint you will see the following OpenAPI contract:
