...
----
include::plantuml/rest-transaction-orm-architecture-diagram.puml[]
----
...
And to add heroes to our database, download the SQL file https://raw.githubusercontent.com/quarkusio/quarkus-workshops/master/quarkus-workshop-super-heroes/api-hero/src/main/resources/import.sql[import.sql] and copy it under `src/main/resources`.
...
/!\ TODO 10 FIRST LINES OF IMPORT.SQL /!\
