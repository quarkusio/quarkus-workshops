...
[source,properties]
----
include::{github-raw}/api-hero/src/main/resources/application.properties[tags=adocHibernate]
----
...
[source]
----
include::{github-raw}/api-hero/src/test/java/io/quarkus/workshop/superheroes/hero/HeroResourceTest.java[tags=adocResourceTest;!adocOpenAPI;!adocHealth;!adocMetrics]
----
