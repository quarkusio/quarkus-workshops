...
[source, java]
----
include::{github-raw}/extensions/extension-banner/deployment/src/main/java/io/quarkus/workshop/superheroes/banner/runtime/BannerConfig.java[]
----
...
[source, java]
----
include::{github-raw}/extensions/extension-banner/deployment/src/main/java/io/quarkus/workshop/superheroes/banner/runtime/BannerProcessor.java[]
----
