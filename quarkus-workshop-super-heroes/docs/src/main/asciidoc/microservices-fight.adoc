...
We recommend however that you add all of the data set by, downloading the SQL file {github-raw}/super-heroes/rest-fight/src/main/resources/import.sql[import.sql] and copying it under `src/main/resources`, tests do depend on the full set.
