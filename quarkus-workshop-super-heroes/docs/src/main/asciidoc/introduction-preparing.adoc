...
Under the `super-heroes` directory you will find a set of subdirectories, each one containing a microservice or some tooling.
...
└── extensions
 ...
    └── extension-fault-injector  Extension to inject network latency and HTTP faults
----
