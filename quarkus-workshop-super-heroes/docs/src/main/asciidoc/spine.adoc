...
<<<
include::quarkus-augmentation.adoc[leveloffset=+1]
<<<
...
<<<
include::messaging-architecture.adoc[leveloffset=+2]
<<<
include::messaging-sending-to-kafka.adoc[leveloffset=+2]
<<<
include::messaging-reading-from-kafka.adoc[leveloffset=+2]
<<<
