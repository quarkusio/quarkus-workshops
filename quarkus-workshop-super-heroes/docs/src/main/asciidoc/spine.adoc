...
<<<
// TODO As optional section - the reactive version of the fight service "API Gateway like"
...
<<<
// Observability - TODO Metrics will need advanced edits as it should use micrometer
...
// Extensions - TODO This section needs to be rewritten completely
