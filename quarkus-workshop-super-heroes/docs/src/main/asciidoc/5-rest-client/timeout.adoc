...
_This chapter is optional, you can jump to the <<messaging>> chapter or to the <<observability>> chapter if you already know about fault-tolerance and timeout._
