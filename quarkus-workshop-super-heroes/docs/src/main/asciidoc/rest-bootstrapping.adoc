...
[INFO] --------------------------------[ jar ]---------------------------------
[INFO]
[INFO] --- quarkus-maven-plugin:1.3.0.Final:dev (default-cli) @ rest-hero ---
...
2020-01-28 15:09:02,111 INFO  [io.quarkus] (main) rest-hero 1.0-SNAPSHOT (running on Quarkus 1.3.0.Final) started in 2.161s. Listening on: http://0.0.0.0:8080
