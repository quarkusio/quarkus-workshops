...
[INFO]
[INFO] --- quarkus-maven-plugin:0.24.0:dev (default-cli) @ rest-hero ---
...
2019-10-04 10:08:12,294 INFO  [io.quarkus] (main) Quarkus 0.24.0 started in 0.891s. Listening on: http://0.0.0.0:8080
