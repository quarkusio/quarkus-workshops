...
[NOTE]
====
If you get stuck and need the full code of the workshop, download {github-raw}/dist/quarkus-super-heroes-workshop.zip.
All the code and documentation of this workshop can be found at {github-url}.
====
