...
Then create a new hero with the following cUrl command.
As you can see, we pass a level of 5 to create this new hero.
...
< Location: http://localhost:8083/api/heroes/957
----
...
[source,shell]
----
$ curl http://localhost:8083/api/heroes/957 | jq
