...
[source,properties]
----
include::{github-raw}/api-hero/src/main/resources/application.properties[tags=adocLogging]
----
...
[source,properties]
----
include::{github-raw}/api-hero/src/main/resources/application.properties[tags=adocPort]
----
