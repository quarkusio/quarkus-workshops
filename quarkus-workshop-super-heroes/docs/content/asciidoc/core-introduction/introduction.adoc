...
If you go to the https://quarkus.io[Quarkus web site], you'll read that Quarkus is "_Supersonic Subatomic Java_." This is a way of saying that Quarkus is really fast, and it’s really light.
